...
export default function Header(){
    return(
        <div className="w-[100%] h-[9.26vh] bg-transparent px-[8rem]  py-[2rem] flex items-center justify-between '">
            ...
            <div className="bg-red-600 py-1 pr-[2.1875rem] pl-7 flex items-center rounded-[4px] cursor-pointer transition-colors duration-300 hover:bg-red-700 "><I_LOGIN/></div>
            </div>
