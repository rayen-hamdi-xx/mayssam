...
export default function TimePicker(props){
    ...
    return (
        <div onClick={()=>props.setOpen(!props.open)} tabIndex={"0"} className={classNames("flex flex-col cursor-pointer justify-between w-fit min-w-[6.5rem]  h-full shadow-input bg-neutral-100 hover:shadow-input_hover_red_50 hover:bg-red-50    rounded-[5px] ",{" p-[0.5rem]":!props.open})}>
                   <AnimatePresence>
                    {
                     !props.open ?
                     <>
                    <p className="text-neutral-500 font-normal h-f text-16 ">Heure</p> 
                    <div className="flex max- items-center gap-[0.75rem] ">
                        <I_CLOCK/>
                        <div className="font-medium text-20  text-neutral-900">
